...
const otraIcon = new L.Icon({
  iconUrl:
    'data:image/svg+xml;base64,' +
    btoa(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#6b7280"><circle cx="12" cy="12" r="10"/></svg>`),
  iconSize: [32, 32],
  iconAnchor: [16, 32],
});
...
useEffect(() => {
  (async () => {
    try {
      ...
      const lista = data?.directorios || data;
